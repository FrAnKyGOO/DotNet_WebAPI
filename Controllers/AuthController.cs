...
namespace DotNet_WebAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IConfiguration config)
        {
            ...
            {
                cfg.CreateMap<UsersRegistrationDto, UsersCompleteModels>();
            }));
        }
        ...
        public IActionResult Register(UsersRegistrationDto userForRegistration)
        {
            if (userForRegistration.Password == userForRegistration.PasswordConfirm)
            {
                ...
                if (existingUsers.Count() == 0)
                {
                    ...
                    {
                        UsersCompleteModels sqlAddUser = _mapper.Map<UsersCompleteModels>(userForRegistration);
                        sqlAddUser.Active = true;

                        if (_reusableSql.UpsertUser(sqlAddUser))
                        {
                            return Ok();
                        }
